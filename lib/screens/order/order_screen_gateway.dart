...
class OrderScreenGateway extends StatefulWidget {
  static String routeName = "/ordergateway";
  ...
  const OrderScreenGateway({Key? key, required this.deliveryModel, required this.shoppingCart, required this.status, required this.paymentMethod, required this.total }) : super(key: key);

  @override
  State<OrderScreenGateway> createState() => _OrderScreenGatewayState();
}

class _OrderScreenGatewayState extends State<OrderScreenGateway> {
