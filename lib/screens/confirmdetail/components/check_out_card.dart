      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                          flex: 2,
                          child: Text(" Discount",style: largeListTextBlack,)
                      ),
                      Spacer(),
                      Expanded(
                          flex: 2,
                          child: Align(
                              alignment: Alignment.centerRight,
                              child: Text("BD ${prefs!.getDouble("discount").toString()}",style: largeListTextBlack,))
                      ),
                    ],
                  ),
                ),
            ...
            if(prefs!.getDouble("discount").toString()!= "null")
              Divider(height: 1,color: kDarkTextColor,),
            Container(
              child: Padding(
                padding: const EdgeInsets.symmetric(vertical: 10.0,horizontal: 10.0),
                child: Row(
