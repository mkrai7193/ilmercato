...
class CheckOutDesign extends StatefulWidget {
  const CheckOutDesign();

  @override
  State<CheckOutDesign> createState() => _CheckOutDesignState();
}

class _CheckOutDesignState extends State<CheckOutDesign> {
